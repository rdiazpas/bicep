...
namespace Bicep.LangServer.IntegrationTests
{
    ...
    {
        public static readonly int SingleFileOpenTimeoutMilliseconds = 5 * 1000;
        ...
        public async Task OpenFileOnce(TestContext testContext, string text, DocumentUri documentUri)
        {
            ...
            await IntegrationTestHelper.WithTimeoutAsync(completionSource.Task, SingleFileOpenTimeoutMilliseconds);
        }
